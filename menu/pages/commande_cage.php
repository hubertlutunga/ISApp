 ...
 <option value="<?php echo $data_event['cod_event']?>" <?php if(@$_POST['event'] == $data_event['cod_event']){echo "selected";} ?>><?php echo $data_event['nom']?></option>
    ...
    <div class="form-group hidden" id="weddingTypeGroup">
        <div class="input-group mb-3">
            ...
            <select class="form-control ps-15 bg-transparent" id="weddingType">
                ...
                <option value="civil">Civil</option>
					...
					<!-- 		
						<div class="form-group">
							<div class="input-group mb-3">
								<span class="input-group-text bg-transparent"><i class="fas fa-gift"></i></i></span> 

								<select class="form-control ps-15 bg-transparent" name="event" id="">
								<option style="color:#eee;" value="">Modèle d'invitation</option>
												 
								
								<?php $reqmod= $pdo->prepare("SELECT * FROM modele_is where type_mod = :type_mod ORDER by nom ASC");
								$reqmod->execute([':type_mod' => 'invitation'
												]);  
  							    while($data_mod=$reqmod->fetch()){
							    ?>
 								<option value="<?php echo $data_mod['cod_mod']?>" <?php if(@$_POST['event'] == $data_mod['cod_mod']){echo "selected";} ?>><?php echo $data_mod['nom']?></option>
								<?php } ?>  
            ...
            if (event.target === modal) {
                modal.style.display = 'none';
							...
							<div class="form-group">
								...
								<input type="checkbox" id="<?php echo $data_mod['cod_mod']?>" class="text-primary">
								...
								<?php } ?> 
									...
									<div class="form-group" style="margin-top:15px;">
										<div class="input-group mb-3">
											...
											<input type="datetime-local" class="form-control ps-15 bg-transparent" placeholder="Date et heure">
										</div>
									</div>
									...
									<div class="form-group">
										<div class="input-group mb-3">
											...
											<input type="text" class="form-control ps-15 bg-transparent" placeholder="Lieu">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<span class="input-group-text bg-transparent"><i class="fas fa-map"></i></span>
											<input type="text" class="form-control ps-15 bg-transparent" placeholder="Adresse">
										</div>
									</div>

									<!-------------------------------anniversaire et conférence------------------------------------->
													
									<div class="form-group hidden" id="NomsAnniv">
										<div class="input-group mb-3">
											<span class="input-group-text bg-transparent"><i class="fas fa-user"></i></span>
											<input type="text" class="form-control ps-15 bg-transparent" placeholder="Noms de fêté">
										</div>
									</div>
									...
									<div class="form-group hidden" id="ThemeConf">
										<div class="input-group mb-3">
											<span class="input-group-text bg-transparent"><i class="fas fa-user"></i></span>
											<input type="text" class="form-control ps-15 bg-transparent" placeholder="Thème de conférence">
										</div>
									</div>
									...
									<div class="form-group hidden" id="NomepouxGroup">
										<div class="input-group mb-3">
											<span class="input-group-text bg-transparent"><i class="fas fa-user"></i></span>
											<input type="text" class="form-control ps-15 bg-transparent" placeholder="Prénom de l'époux">
										</div>
									</div>
									...
									<div class="form-group hidden" id="PrenomepouxGroup">
										<div class="input-group mb-3">
											<span class="input-group-text bg-transparent"><i class="fas fa-user"></i></span>
											<input type="text" class="form-control ps-15 bg-transparent" placeholder="Nom de l'époux">
										</div>
									</div>
									...
									<div class="form-group hidden" id="NomepouseGroup">
										<div class="input-group mb-3">
											<span class="input-group-text bg-transparent"><i class="fas fa-user"></i></span>
											<input type="text" class="form-control ps-15 bg-transparent" placeholder="Prénom de l'épouse">
										</div>
									</div>
									...
									<div class="form-group hidden" id="PrenomepouseGroup">
										<div class="input-group mb-3">
											<span class="input-group-text bg-transparent"><i class="fas fa-user"></i></span>
											<input type="text" class="form-control ps-15 bg-transparent" placeholder="Nom de l'épouse">
										</div>
									</div>
									...
									<div class="form-group hidden" id="NomfamilleepouxGroup">
										<div class="input-group mb-3">
											<span class="input-group-text bg-transparent"><i class="fas fa-user"></i></span>
											<input type="text" class="form-control ps-15 bg-transparent" placeholder="Nom de Famille de l'époux">
										</div>
									</div>
									...
									<div class="form-group hidden" id="NomfamilleepouseGroup">
										<div class="input-group mb-3">
											<span class="input-group-text bg-transparent"><i class="fas fa-user"></i></span>
											<input type="text" class="form-control ps-15 bg-transparent" placeholder="Nom de Famille de l'épouse">
										</div>
									</div>
									...
									<div class="form-group">
										<div class="input-group mb-3">
											...
											<textarea name="details"  class="form-control ps-15 bg-transparent" rows='5' placeholder="Autres précisions" id=""></textarea>
										</div>
									</div>

 ...
 ?>
                    ...
                    <tr style="margin-bottom:15px;">
                      <td  align="left" style="border-bottom:1px solid #aaa;padding: 5px 0px 5px 0px;height:50px;"><?php echo $row_inv['nom']; ?></td>
                       <td  align="right" style="border-bottom:1px solid #aaa;padding: 5px 0px 5px 0px;"><a href="pages/invitation2.php?cod=<?php echo $row_inv['id_inv']?>" target="_blink" style="color:#0766d8;"><i class="fas fa-file"></i></a></td>
                    </tr>
                              <?php 

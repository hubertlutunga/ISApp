...
<form action="" method="post">
    ...
    <div class="form-group">
        <div class="input-group mb-3">
            ...
            <input type="password" name="password"  value="<?php echo @$_POST['password']?>" class="form-control ps-15 bg-transparent" placeholder="Mot de passe" required>
        </div>
    </div>
    <div class="form-group">
        <div class="input-group mb-3">
            <span class="input-group-text bg-transparent"><i class="fas fa-lock"></i></span>
            <input type="password" name="confirm_password" value="<?php echo @$_POST['confirm_password']?>" class="form-control ps-15 bg-transparent" placeholder="Confirmer mot de passe" required>
        </div>
    </div>
    <div class="row">
        <div class="col-12">

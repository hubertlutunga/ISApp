...
//---------------compte depot com------------------
      ...
      $sqlcli = "SELECT COUNT(Distinct code_cli) as total_cli from commandes where typecli = '4' AND code_prodvente = '{$row_list_com['code_prodvente']}' AND YEAR(date_enreg) = '$daty' AND Month(date_enreg) = '$datm'";
...
//------------compte livraison com-----------------
      ...
      $sqldl = "SELECT sum(qte_liv) AS total_liv from com_livraison WHERE cod_produit = '{$row_list_com['code_prodvente']}' AND  YEAR(date_liv) = '$daty' AND Month(date_liv) = '$datm'";
      $dl = $pdo->query($sqldl);  
      $row_dl = $dl->fetch();
...
//--------------stock recu-----------------------
      ...
      $sqlt = "SELECT sum(qte) AS total_n from stock_transfere where cod_produit = '{$row_list_com['code_prodvente']}' AND id_depar =  '4' AND YEAR(date_enreg) = '$daty' AND Month(date_enreg) = '$datm' AND recu = 'oui'";
      $reqt = $pdo->query($sqlt);  
...
//----------------------stock retour--------------------------------
      ...
      $sqlcom = "SELECT sum(qte) AS total_nc from commandes where typecli = '4' AND code_prodvente = '{$row_list_com['code_prodvente']}' AND YEAR(date_enreg) = '$daty' AND Month(date_enreg) = '$datm' AND statut = 'liv'";

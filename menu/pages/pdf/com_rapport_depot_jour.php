  ...
  //include('../phpqrcode/qrlib.php'); 
	...
	class myPDF extends FPDF{
      ...
      $datd = date('d');
			...
			$this->Cell(195,8,utf8_decode('Du: ('.date('d M Y').')'),0,0,'C');
			$this->Ln(5);	
			$this->SetTextColor(0, 0, 0);
			$this->SetFont('Arial','',11);		
			$this->Ln(10);	
      ...
      $agent = $row_agent['matr_user'];
			...
			$this->Cell(28,15,utf8_decode('Livré'),1,0,'C',true);
      ...
      $sql = "SELECT distinct code_prodvente from commandes where typecli = '4' AND YEAR(date_enreg) = '$daty' AND YEAR(date_enreg) = '$daty' AND Month(date_enreg) = '$datm' AND DAY(date_enreg) = '$datd' AND agent = '$agent' order by code_com ASC";
      $req = $pdo->query($sql);  
...
//---------------compte depot com------------------
      ...
      $sqlcli = "SELECT COUNT(Distinct code_cli) as total_cli from commandes where typecli = '4' AND code_prodvente = '{$row_list_com['code_prodvente']}' AND YEAR(date_enreg) = '$daty' AND Month(date_enreg) = '$datm' AND DAY(date_enreg) = '$datd'";
...
//------------compte livraison com-----------------
      ...
      $sqldl = "SELECT sum(qte_liv) AS total_liv from com_livraison WHERE cod_produit = '{$row_list_com['code_prodvente']}' AND YEAR(date_liv) = '$daty' AND Month(date_liv) = '$datm' AND DAY(date_liv) = '$datd'";
      $dl = $pdo->query($sqldl);  
      $row_dl = $dl->fetch();
...
//--------------stock recu-----------------------
      ...
      $sqlt = "SELECT sum(qte) AS total_n from stock_transfere where cod_produit = '{$row_list_com['code_prodvente']}' AND id_depar =  '4' AND YEAR(date_enreg) = '$daty' AND Month(date_enreg) = '$datm' AND DAY(date_enreg) = '$datd' AND recu = 'oui'";
      $reqt = $pdo->query($sqlt);  
...
//--------------nombre des commande produit-----------------------
      ...
      $sqlqtecom = "SELECT sum(qte) AS total_n from commandes where typecli = '4' AND code_prodvente = '{$row_list_com['code_prodvente']}' AND YEAR(date_enreg) = '$daty' AND Month(date_enreg) = '$datm' AND DAY(date_enreg) = '$datd' AND agent = '$agent' AND code_cli != 'GROSS' AND code_cli != 'NULL'";
      ...
      $sqlmont_comt = "SELECT sum(pvt) AS total_n from commandes where  typecli = '4' AND code_prodvente = '{$row_list_com['code_prodvente']}' AND YEAR(date_enreg) = '$daty' AND Month(date_enreg) = '$datm' AND DAY(date_enreg) = '$datd' AND agent = '$agent' AND code_cli != 'GROSS' AND code_cli != 'NULL'";
...
//--------------nombre des commande produit GROSS-----------------------
      ...
      $sqlqtecomgross = "SELECT sum(qte) AS total_n from commandes where typecli = '4' AND code_prodvente = '{$row_list_com['code_prodvente']}' AND YEAR(date_enreg) = '$daty' AND Month(date_enreg) = '$datm' AND DAY(date_enreg) = '$datd' AND agent = '$agent' AND code_cli = 'GROSS'";
      ...
      $sqlmont_gross = "SELECT sum(pvt) AS total_n from commandes where typecli = '4' AND code_prodvente = '{$row_list_com['code_prodvente']}' AND YEAR(date_enreg) = '$daty' AND Month(date_enreg) = '$datm' AND DAY(date_enreg) = '$datd' AND agent = '$agent' AND code_cli = 'GROSS'";
...
//--------------nombre des commande produit passant-----------------------
      ...
      $sqlqtecompassant = "SELECT sum(qte) AS total_n from commandes where typecli = '4' AND code_prodvente = '{$row_list_com['code_prodvente']}' AND YEAR(date_enreg) = '$daty' AND Month(date_enreg) = '$datm' AND DAY(date_enreg) = '$datd' AND agent = '$agent' AND code_cli = 'NULL'";
      ...
      $sqlmont_pass = "SELECT sum(pvt) AS total_n from commandes where typecli = '4' AND code_prodvente = '{$row_list_com['code_prodvente']}' AND YEAR(date_enreg) = '$daty' AND Month(date_enreg) = '$datm' AND DAY(date_enreg) = '$datd' AND agent = '$agent' AND code_cli = 'NULL'";
...
//--------------------------------calucule dette-----------------
      ...
      $sqlcomcred = "SELECT sum(pvt) AS total_ccr from commandes where typecli = '4' AND code_prodvente = '{$row_list_com['code_prodvente']}' AND YEAR(date_enreg) = '$daty' AND Month(date_enreg) = '$datm' AND DAY(date_enreg) = '$datd' AND agent = '$agent' AND typ_paie = 'TR'";
      $comcred = $pdo->query($sqlcomcred);  
      $row_comcred = $comcred->fetch();

      $sqlcalcr = "SELECT sum(pvt) AS total_calcr from commandes where typecli = '4' AND code_prodvente = '{$row_list_com['code_prodvente']}' AND YEAR(date_enreg) = '$daty' AND Month(date_enreg) = '$datm' AND DAY(date_enreg) = '$datd' AND agent = '$agent' AND typ_paie = 'CR'";  
      ...
      $row_calcr = $calcr->fetch();
          ...
          $sqlcred = "SELECT sum(montant) as total_cred from dette_paie where  YEAR(date_ce) = '$daty' AND Month(date_ce) = '$datm' AND DAY(date_ce) = '$datd' AND agent = '$agent'";
...
//----------------------stock retour--------------------------------
      ...
      $stock_total_recu = $row_nstock['total_n'];


      $sqlcom = "SELECT sum(qte) AS total_nc from commandes where typecli = '4' AND code_prodvente = '{$row_list_com['code_prodvente']}' AND YEAR(date_enreg) = '$daty' AND Month(date_enreg) = '$datm' AND DAY(date_enreg) = '$datd' AND agent = '$agent' AND statut = 'liv'";
      $reqcom = $pdo->query($sqlcom);  
      $row_ncom = $reqcom->fetch();


      $total_uitilise = $row_ncom['total_nc'] ; 

       $disponible = $stock_total_recu - $total_uitilise;
...
$this->Cell(20,10,$livraison,1,0,'C');
			$this->Cell(28,10,utf8_decode($disponible),1,0,'C',true);
...
//--------------------------------calcule total nombre op-----------------
      ...
      $sqlcomttid = "SELECT count(code_com) AS total_id from commandes where typecli = '4' AND YEAR(date_enreg) = '$daty' AND Month(date_enreg) = '$datm' AND DAY(date_enreg) = '$datd' AND agent = '$agent'";
      $comttid = $pdo->query($sqlcomttid);  
      $row_comttid = $comttid->fetch();

//--------------------------------calcule total qte com-----------------

      $sqlcomtt = "SELECT sum(qte) AS total_com from commandes where typecli = '4' AND YEAR(date_enreg) = '$daty' AND Month(date_enreg) = '$datm' AND DAY(date_enreg) = '$datd' AND agent = '$agent'";
      $comtt = $pdo->query($sqlcomtt);  
      $row_comtt = $comtt->fetch();

//--------------------------------calcule total somme com-----------------

      $sqlcomsom = "SELECT sum(pvt) AS total_com from commandes where typecli = '4' AND YEAR(date_enreg) = '$daty' AND Month(date_enreg) = '$datm' AND DAY(date_enreg) = '$datd' AND agent = '$agent'";
...
//--------------------------------calucule dette-----------------
      ...
      $sqlcomcredtt = "SELECT sum(pvt) AS total_ccr from commandes where typecli = '4' AND YEAR(date_enreg) = '$daty' AND Month(date_enreg) = '$datm' AND DAY(date_enreg) = '$datd' AND agent = '$agent' AND typ_paie = 'TR'";
      $comcredtt = $pdo->query($sqlcomcredtt);  
      $row_comcredtt = $comcredtt->fetch();

      $sqlcalcrtt = "SELECT sum(pvt) AS total_calcr from commandes where typecli = '4' AND YEAR(date_enreg) = '$daty' AND Month(date_enreg) = '$datm' AND DAY(date_enreg) = '$datd' AND agent = '$agent' AND typ_paie = 'CR'";  
      ...
      $row_calcrtt = $calcrtt->fetch();
          ...
          $sqlcredtt = "SELECT sum(montant) as total_cred from dette_paie where  YEAR(date_ce) = '$daty' AND Month(date_ce) = '$datm' AND DAY(date_ce) = '$datd' AND agent = '$agent'";

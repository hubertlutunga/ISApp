  ...
  //include('../phpqrcode/qrlib.php'); 
	...
	class myPDF extends FPDF{
		...
		function infodf($pdo){
			...
			$this->Ln(8);	
			$this->Cell(270,8,utf8_decode('('.$_GET['da'].' du '.$_GET['db'].')'),0,0,'C');
			$this->Ln(5);	
			$this->SetTextColor(0, 0, 0);
			$this->SetFont('Arial','',11);		
			$this->Ln(10);	
      ...
      $sqlx = "SELECT * from stock_transfere where date_enreg between '$ha' and '$hb' AND id_depar =  '4' AND recu = 'oui' order by id_st DESC";
      $reqx = $pdo->query($sqlx);  
      ...
      $sqltd = "SELECT sum(qte) AS total_n from stock_transfere where date_enreg between '$ha' and '$hb' AND id_depar =  '4' AND recu = 'oui'";
      ...
      $sqlx = "SELECT * from stock_transfere where date_enreg between '$ha' and '$hb' AND id_depar =  '2' AND recu = 'oui' order by id_st DESC";
      $reqx = $pdo->query($sqlx);  
      while ($row_trans = $reqx->fetch()) {
      ...
      $sqltm = "SELECT sum(qte) AS total_n from stock_transfere where date_enreg between '$ha' and '$hb' AND id_depar =  '2' AND recu = 'oui'";
      ...
      $sqlx = "SELECT * from stock_transfere where date_enreg between '$ha' and '$hb' AND recu = 'oui' order by id_st DESC";
      $reqx = $pdo->query($sqlx);  
      while ($row_trans = $reqx->fetch()) {
      ...
      $sqltt = "SELECT sum(qte) AS total_n from stock_transfere where date_enreg between '$ha' and '$hb' AND recu = 'oui'";

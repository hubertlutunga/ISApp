  ...
  //include('../phpqrcode/qrlib.php'); 
	...
	class myPDF extends FPDF{
      ...
      $sqlx = "SELECT * from commandes where YEAR(date_enreg) = '$daty' AND Month(date_enreg) = '$datm' order by code_com DESC";
      $reqx = $pdo->query($sqlx);  
      ...
      if ($row_com) {
        $rowcom = $row_com['agent'];
      }else{
        $rowcom = "NULL";
      }


      $sqlv = "SELECT * from abc_user WHERE matr_user = '$rowcom'";
      $reqv = $pdo->query($sqlv);  

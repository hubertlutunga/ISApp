...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box}body{margin:0;font-family:Inter,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;color:var(--ink);background:radial-gradient(circle at 10% 0%,rgba(22,181,168,.16),transparent 30rem),radial-gradient(circle at 90% 0%,rgba(215,53,74,.12),transparent 28rem),linear-gradient(180deg,#fff9ee,#f4e6d2);min-height:100vh}a{color:inherit}.shell{width:min(980px,100%);margin:0 auto;padding:28px clamp(16px,4vw,46px) 54px}.top{display:flex;justify-content:space-between;gap:18px;align-items:center;margin-bottom:24px}.brand{display:flex;align-items:center;gap:14px}.brand img{width:64px;height:64px;object-fit:contain;background:#fff;border-radius:18px;padding:7px;box-shadow:0 14px 34px rgba(53,24,11,.16)}h1{font-size:clamp(30px,4vw,48px);line-height:1;margin:0;letter-spacing:-.06em}.muted{color:var(--muted);font-weight:700}.card{background:rgba(255,250,241,.94);border:1px solid rgba(139,74,31,.14);border-radius:28px;box-shadow:var(--shadow);padding:24px;margin-bottom:20px}label{display:block;font-weight:900;margin:0 0 8px}input,select{width:100%;border:1px solid #d9c5a8;border-radius:14px;background:#fff;padding:12px 13px;font:inherit;color:var(--ink)}.grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:16px}.field{margin-bottom:16px}.check{display:flex;gap:10px;align-items:center;font-weight:900}.check input{width:auto}.btn{display:inline-flex;align-items:center;justify-content:center;border:0;border-radius:999px;padding:12px 18px;font-weight:900;cursor:pointer;text-decoration:none}.btn-primary{background:linear-gradient(135deg,var(--red),var(--wood),var(--blue));color:#fff}.btn-soft{background:#f3dfc2;color:var(--wood-dark)}.alert{margin:0 0 18px;padding:13px 15px;border-radius:16px;font-weight:800}.alert-error{background:#fff1f0;color:#b42318;border:1px solid #ffccc7}.alert-ok{background:#ecfdf5;color:#0f766e;border:1px solid #a7f3d0}.error{color:#b42318;font-weight:800;font-size:13px;margin-top:7px}.table-wrap{overflow:auto;border-radius:20px;border:1px solid var(--line);background:#fff}table{width:100%;border-collapse:collapse;min-width:760px}th,td{padding:13px;border-bottom:1px solid #f0dfc8;text-align:left}th{font-size:12px;text-transform:uppercase;letter-spacing:.08em;color:#745139;background:#fff8ed}.badge{display:inline-flex;padding:6px 10px;border-radius:999px;background:#f3dfc2;color:var(--wood-dark);font-weight:900;font-size:12px}.admin-footer{margin:28px auto 0;padding:18px 10px;color:var(--muted);display:grid;justify-items:center;gap:12px;text-align:center;font-weight:900}.admin-footer__logos{display:flex;align-items:center;justify-content:center;gap:16px;flex-wrap:wrap}.admin-footer__logos img{width:86px;height:64px;object-fit:contain}.admin-footer__logos img.is-footer-logo{width:150px}@media(max-width:760px){.top,.grid{grid-template-columns:1fr;display:grid}.btn{width:100%}.admin-footer__logos img.is-footer-logo{width:130px}}
    </style>
</head>
<body>
<main class="shell">

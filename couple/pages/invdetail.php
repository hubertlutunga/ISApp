...
<div id="preloader">
 ...
 .bg-slideshowx {
   ...
   height: 100vh;
    ...
    $reqinv="SELECT * FROM confirmation where cod_conf = '{$_GET['id']}'";
    $inv=$pdo->query($reqinv);
    $row_inv=$inv->fetch();


    if ($row_inv['presence'] == "oui") {
        $presence = "Y prendra part";
      }else{
        $presence = 'Ne pourra pas prendre part, désolé !';
      }
    ...
    ?>	
		...
		<section id="the-wedding" class="parallax-background bg-color-overlay padding-divider-top">
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-12">
						<h2 class="section-title light"><?php echo $row_inv['noms']; ?></h2>
                        <h4 style="font-style:italic;text-align:center;"><?php echo $presence; ?></h4>
					</div>
				</div>
        ...
        <table width="80%" style="margin-bottom:100px;" align="center"> 
                    ...
                    <tr style="margin-bottom:15px;">
                      <td  align="left" style="text-align:center;border-bottom:1px solid #aaa;padding: 7px 0px 7px 0px;">
					  <?php echo $row_inv['email'] ? : ''; ?>
                    </tr>  
                       
                       <tr style="margin-bottom:15px;">
                         <td  align="left" style="text-align:center;border-bottom:1px solid #aaa;padding: 7px 0px 7px 0px;">
                        <?php echo $row_inv['phone'] ? : ''; ?>
                       </tr>  
                       
                       <tr style="margin-bottom:15px;">
                         <td  align="left" style="text-align:center;border-bottom:1px solid #aaa;padding: 7px 0px 7px 0px;">
                        <?php echo $row_inv['typerepas'] ? : ''; ?>
                       </tr>  
                       
                       <tr style="margin-bottom:15px;">
                         <td  align="left" style="text-align:center;border-bottom:1px solid #aaa;padding: 7px 0px 7px 0px;">
                        <?php echo $row_inv['note'] ? : ''; ?>
                       </tr>  

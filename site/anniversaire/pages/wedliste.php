		...
		<header id="header">
			<div class="nav-section">
				<div class="container">
					<div class="row">
						<div class="col-sm-12">
                        <a style="font-family: 'Great Vibes', cursive;font-size:40px;margin-top:-2px;" href="index.php?page=accueil&cod=<?php echo $codmariage?>" class="nav-logo"><?php echo $datamariage['initiale_mar'];?></a></a>

            ...
            <div class="container py-30 admin-messages-page">
                ...
                <form method="post" id="adminClientMessageForm" class="am-layout">
                    ...
                    <section class="am-card am-composer-card">
                        ...
                        <div class="am-template-meta">
                            <span>SID Twilio</span>
                            <strong id="templateSidPreview"><?php echo htmlspecialchars((string) $templates[$selectedTemplateKey]['sid'], ENT_QUOTES, 'UTF-8'); ?></strong>
                        </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const sidPreview = document.getElementById('templateSidPreview');
    ...
    function updateTemplatePreview() {
        ...
        if (sidPreview) {
            sidPreview.textContent = template.sid;
        }
        if (messagePreview) {

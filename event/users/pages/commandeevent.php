...
<?php 
  $totalCommandes = MenuOrderService::countByEvent($pdo, (int) $codevent);
?>
			...
			<section class="content">
				<div class="box box-body">
                    ...
                    <h2 class="text-dark hover-primary m-0 fw-600"><?php echo $totalCommandes; ?></h2>
                    <span class="text-fade fs-12">Commandes des boissons de cet événement</span>
                                        </a>
									</div>
								</div>
							</div>
            ...
            <div class="card-body pt-0">
                <div class="table-responsive">
                    <table class="table mb-0">
                        <tbody>
                            <?php 
                          $commandes = MenuOrderService::listByEvent($pdo, (int) $codevent);

                          if (!empty($commandes)) {
                            foreach ($commandes as $row_com) {
                              $nominv = $row_com['invite_nom'] ?? '';
                              $table = $row_com['table_nom'] ?? '';
                              $menu = $row_com['menu_nom'] ?? '';
                             ...
                             ?> 
									...
									<p>Commande : <?php echo htmlspecialchars(ucfirst($menu)); ?>
                                    <hr>
...
?>
            <div class="form-group"> 
                ...
                <input type="text" required pattern="^\+\d{1,3}\d{9,}$" oninvalid="this.setCustomValidity(this.value ? 'Veuillez entrer un numero WhatsApp au format international complet (ex: +243XXXXXXXXX).' : 'Veuillez renseigner un numero WhatsApp.');" oninput="this.setCustomValidity('');"
	      			id="whatsappNumber" name="phoneinv" class="input-group-text bg-transparent" style="border-radius:7px 7px 0px 0px;height:45px;width:100%;" placeholder="(+243XXXXXXXXX)" />

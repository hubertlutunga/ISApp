  ...
  <div class="wrapper"> 
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        ...
        <div class="card-body pt-0" style="border-radius: 10px; background-color: #fff; padding: 20px; margin-top: 10px;">
          <br>
          <div style="display:flex; align-items:center; justify-content:space-between; gap:12px; margin-bottom:12px;">
            <h4 class="box-title" style="margin:0; color:#1f2a44;">Les commandes</h4>
            <a href="javascript:void(0)" onclick="openSearchModal()" class="waves-effect waves-light btn btn-outline btn-rounded btn-primary btn-sm">
              <i class="fa fa-search"></i> Rechercher
            </a>
          </div>
          <div style="height:1px; background:#e6e9f2; margin-bottom:18px;"></div>
              ...
              html: `
                <form method="get" action="index.php" id="searchForm">
                  ...
                  <input
                    ...
                    name="search"
                    class="swal2-input"
                    placeholder="Prénom des mariés"
                    required
                    style="width:80%"
                    value="<?= htmlspecialchars($_GET['search'] ?? '') ?>"
                  >
                  <button type="submit" class="swal2-confirm swal2-styled" style="display:inline-block; margin-top:10px; width:80%;">
                    Rechercher
                  </button>
                </form>
              `,
...
function openModal(codEvent) {
    ...
    document.getElementById('codevent').value = codEvent;
...
function openModal3(codEvent) {
    ...
    document.getElementById('codevent3').value = codEvent;
        ...
        <div class="row" id="mesinv">
          <div class="col-xxl-12 col-xl-12 col-lg-12">
            <div class="card rounded-4">
              ...
              <div class="card-body pt-0" style="background:#000; border-radius:0 0 1rem 1rem; padding:18px;">
                <div class="table-responsive">

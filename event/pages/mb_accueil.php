...
<html lang="en">
  <head>
    ...
    <title>Cartiy Admin - Dashboard</title>
...
<div class="wrapper"> 
  ...
  <nav class="main-nav" role="navigation">
	  ...
	  <ul id="main-menu" class="sm sm-blue">		
		<li><a href=""><i data-feather="home"><span class="path1"></span><span class="path2"></span></i>Dashboard</a>
			<ul>
		...
		<li><a href="#"><i data-feather="database"></i>Apps</a>
			<ul> 
								...
								<div class="d-flex align-items-center">
									<div class="w-70 h-70 me-15 bg-primary-light rounded-circle text-center p-10">
										<div class="w-50 h-50 bg-primary rounded-circle">
											<i class="fa fa-shopping-cart fs-24 l-h-50"></i>
										</div>
									</div>
									<div class="d-flex flex-column">
										<span class="text-fade fs-12">Orders Completed</span>
										<h2 class="text-dark hover-primary m-0 fw-600">2.5k</h2>
									</div>
								</div>
							</div>
						</div>
								...
								<div class="d-flex align-items-center">
									<div class="w-70 h-70 me-15 bg-info-light rounded-circle text-center p-10">
										<div class="w-50 h-50 bg-info rounded-circle">
											<i class="fa fa-fw fa-bar-chart fs-20 l-h-50"></i>
										</div>		
									</div>
									<div class="d-flex flex-column">
										<span class="text-fade fs-12">Total Revenue</span>
										<h2 class="text-dark hover-primary m-0 fw-600">$200k</h2>
									</div>
								</div>
							</div>
						</div>
								...
								<div class="d-flex align-items-center">
									<div class="w-70 h-70 me-15 bg-danger-light rounded-circle text-center p-10">
										<div class="w-50 h-50 bg-danger rounded-circle">
											<i class="fa fa-user-circle-o fs-20 l-h-50"></i>	
										</div>		
									</div>
									<div class="d-flex flex-column">
										<span class="text-fade fs-12">Total Visits</span>
										<h2 class="text-dark hover-primary m-0 fw-600">1.5m</h2>
									</div>
								</div>
							</div>
						</div>
								...
								<div class="d-flex align-items-center">
									<div class="w-70 h-70 me-15 bg-warning-light rounded-circle text-center p-10">
										<div class="w-50 h-50 bg-warning rounded-circle">
											<i class="fa fa-pie-chart fs-24 l-h-50"></i>
										</div>	
									</div>
									<div class="d-flex flex-column">
										<span class="text-fade fs-12">Total Sales</span>
										<h2 class="text-dark hover-primary m-0 fw-600">30,145</h2>
									</div>
								</div>
							</div>
						</div>	
				...
				<div class="row">
					<div class="col-xxxl-8 col-xxl-8 col-xl-8 col-lg-7">
						<div class="card rounded-4">
							<div class="box-header d-flex b-0 justify-content-between align-items-center pb-0">
								<h4 class="box-title">Earning Revenue</h4>
								<ul class="m-0" style="list-style: none;">
									<li class="dropdown">
										<button class="waves-effect waves-light btn btn-outline btn-rounded btn-primary mb-5 dropdown-toggle btn-sm" data-bs-toggle="dropdown" href="#" aria-expanded="false">Today</button>
									...
									<div class="box-body fill-img">
										<div class="d-flex align-items-center">
											<div class="w-80 h-80 me-15 bg-danger-light rounded-3 text-center p-5">
												<div class="w-70 h-70 bg-light rounded-3">
													<img src="../../../images/dashobard/image-1.png" >
												</div>	
											</div>
											<div class="d-flex flex-column">
												<h4 class="text-fade mb-1">Order Reserved From Website</h4>
												<h2 class="text-danger hover-primary m-0 fw-600">30.12k</h2>
											</div>
										</div>
									...
									<div class="box-body fill-img">
										<div class="d-flex align-items-center">
											<div class="w-80 h-80 me-15 bg-success-light rounded-3 text-center p-5">
												<div class="w-70 h-70 bg-light rounded-3">
													<img src="../../../images/dashobard/image-2.png" >
												</div>	
											</div>
											<div class="d-flex flex-column">
												<h4 class="text-fade mb-1">Order Reserved From Mobile App</h4>
												<h2 class="text-success hover-primary m-0 fw-600">50.16k</h2>
											</div>
										</div>
										<div class="progress mb-2 progress-sm mt-20">
					...
					<div class="col-12">
						<div class="box">
							<div class="box-header d-flex justify-content-between align-items-center">
							  	<h4 class="box-title">Our Products</h4>
							  	<ul class="m-0" style="list-style: none;">
									<li class="dropdown">
										<button class="waves-effect waves-light btn btn-outline btn-rounded btn-primary btn-sm" href="#" aria-expanded="false">View All</button>
									</li>
								</ul>
							</div>
							<!-- /.box-header -->
							<div class="box-body">				  
								<div class="owl-carousel owl-theme" id="owl-carousel-13">
									<div class="box mb-0">
										<img class="card-img-top img-responsive" src="../../../images/dashobard/1.jpg" alt="Card image cap">
									</div>
									<div class="box mb-0">
										<img class="card-img-top img-responsive" src="../../../images/dashobard/2.jpg" alt="Card image cap">
									</div>
									<div class="box mb-0">
										<img class="card-img-top img-responsive" src="../../../images/dashobard/3.jpg" alt="Card image cap">
									</div>
									<div class="box mb-0">
										<img class="card-img-top img-responsive" src="../../../images/dashobard/4.jpg" alt="Card image cap">
									</div>
									<div class="box mb-0">
										<img class="card-img-top img-responsive" src="../../../images/dashobard/5.jpg" alt="Card image cap">
									</div>
									<div class="box mb-0">
										<img class="card-img-top img-responsive" src="../../../images/dashobard/6.jpg" alt="Card image cap">
									</div>
									<div class="box mb-0">
										<img class="card-img-top img-responsive" src="../../../images/dashobard/7.jpg" alt="Card image cap">
									</div>
									<div class="box mb-0">
										<img class="card-img-top img-responsive" src="../../../images/dashobard/8.jpg" alt="Card image cap">
									</div>
									<div class="box mb-0">
										<img class="card-img-top img-responsive" src="../../../images/dashobard/9.jpg" alt="Card image cap">
									</div>
									<div class="box mb-0">
										<img class="card-img-top img-responsive" src="../../../images/dashobard/10.jpg" alt="Card image cap">
									</div>
								</div>
							</div>
					  	</div>  
					...
					<div class="row">
						<div class="col-xxxl-4 col-xxl-4 col-xl-4 col-lg-12">
							<div class="card rounded-4">
								<div class="box-header">
									<h4 class="box-title">Visitor Insights</h4>
								</div>
						...
						<div class="col-xxxl-8 col-xxl-8 col-xl-8 col-lg-12">
							<div class="box rounded-4">
								<div class="box-header d-flex b-0 justify-content-between align-items-center pb-0">
									<h4 class="box-title">Today's Sales</h4>
									<ul class="m-0" style="list-style: none;">
										<li class="dropdown">
											<button class="waves-effect waves-light btn btn-outline btn-rounded btn-primary btn-sm" href="#"><i class="fa fa-fw fa-arrow-down"> </i> Export</button>
										</li>
									</ul>
								</div>
								<div class="box-body pt-0 summery-box">
									<p class="mb-20 text-fade">Today's Sales Summery</p>
									<div class="row">
										<div class="col-lg-3 col-md-6">
	                                        <div class="box pull-up mb-sm-0 bg-danger-light">
	                                          	<div class="box-body ">
		                                            ...
		                                            <h2	 class="fw-600 mt-3">$20k</h2	>
		                                            <p class="text-fade fw-500 mb-2">Total Sales</p>
		                                            <p class="mb-0 text-primary">+8% from yesterday</p>
	                                          	</div>
	                                        </div>
	                                    </div>
	                                    <div class="col-lg-3 col-md-6">
	                                        <div class="box pull-up mb-sm-0 bg-warning-light">
	                                          	<div class="box-body ">
		                                            ...
		                                            <h2	 class="fw-600 mt-3">500</h2	>
		                                            <p class="text-fade fw-500 mb-2">Total Order</p>
		                                            <p class="mb-0 text-primary">+5% from yesterday</p>
	                                          	</div>
	                                        </div>
	                                    </div>
	                                    <div class="col-lg-3 col-md-6">
	                                        <div class="box pull-up mb-0 bg-info-light">
	                                          	<div class="box-body ">
		                                            ...
		                                            <h2	 class="fw-600 mt-3">50</h2	>
		                                            <p class="text-fade fw-500 mb-2">Product Sold</p>
		                                            <p class="mb-0 text-primary">+2% from yesterday</p>
	                                          	</div>
	                                        </div>
	                                    </div>
	                                    <div class="col-lg-3 col-md-6">
	                                        <div class="box pull-up mb-0 bg-danger-light">
	                                          	<div class="box-body ">
		                                            ...
		                                            <h2	 class="fw-600 mt-3">15</h2	>
		                                            <p class="text-fade fw-500 mb-2">New Customers</p>
		                                            <p class="mb-0 text-primary">+1% from yesterday</p>
	                                          	</div>
	                                        </div>
	                                    </div>
									</div>
					...
					<div class="row">
								...
								<div class="card-body p-0">
									<div class="chart">
										...
										<div class="row border-top">
		                                    <div class="col-md-6 col-6 p-0 border-end text-end">
		                                        <p class="mb-0 p-3">
		                                            <i class="fa fa-square text-success"> </i> Last Month
		                                        </p>
		                                    </div>
		                                    <div class="col-md-6 col-6 p-0">
		                                        <p class="mb-0 p-3"><i class="fa fa-square text-primary"> </i> This Month</p>
		                                    </div>
		                                </div>
									</div>
								</div>
						...
						<div class="col-xxxl-4 col-xxl-4 col-xl-4 col-lg-12">
							<div class="card rounded-4">
								<div class="box-header b-0">
									<h4 class="box-title">Reality Vs Target</h4>
								</div>
								<div class="card-body p-5">
									<div class="chart">
										<div id="Reality-chart"></div>
										<div class="row">
											<div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-12 be-1">
												<div class="box-body rounded-0 px-15 pb-5 pt-0 fill-icon">
													<div class="d-flex align-items-center">
														...
														<div class="d-flex flex-column">
															<span class="text-fade fs-12">Reality Sales</span>
															<h2 class="text-dark hover-primary m-0 fw-600">9.2%</h2>
														</div>
													</div>
												</div>
											</div>
											<div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-12">
												<div class="box-body rounded-0 px-15 pb-5 pt-0 fill-icon">
													<div class="d-flex align-items-center">
														...
														<div class="d-flex flex-column">
															<span class="text-fade fs-12">Target Sales</span>
															<h2 class="text-dark hover-primary m-0 fw-600">12.5%</h2>
														</div>
													</div>
												</div>
											</div>
						...
						<div class="col-xxl-3 col-xl-6 col-lg-6">
							<div class="card rounded-4">
								<div class="box-header d-flex b-0 justify-content-between align-items-center">
									...
									<p class="text-primary m-0">+0.45%</p>
								</div>
											...
											<tbody>
		                                        <tr>
		                                          <td class="pt-0 px-0 b-0 w-50">
		                                          	<img class="img-fluid img-40 rounded-circle w-40 h-40 bg-light p-1" src="../../../images/avatar/avatar-1.png" alt="user">
		                                          </td>
		                                          <td class="pt-0 px-0 b-0"><a class="d-block fw-500 fs-14" href="#">Alina</a><span class="text-fade">ID 45691</span></td>
		                                          <td class="text-end b-0 pt-0 px-0">
		                                            <button class="waves-effect waves-light btn btn-outline btn-rounded btn-primary mb-0 btn-sm">Deliverd</button>
		                                          </td>
		                                        </tr>
		                                        <tr>
		                                          <td class="pt-0 px-0 b-0 w-50"><img class="img-fluid img-40 rounded-circle w-40 h-40 bg-light p-1" src="../../../images/avatar/avatar-2.png" alt="user"></td>
		                                          <td class="pt-0 px-0 b-0"><a class="d-block fw-500 fs-14" href="#">Moris</a><span class="text-fade">ID 74586</span></td>
		                                          <td class="text-end b-0 pt-0 px-0">
		                                            <button class="waves-effect waves-light btn btn-outline btn-rounded btn-warning mb-0 btn-sm">Panding</button>
		                                          </td>
		                                        </tr>
		                                        <tr>
		                                          <td class="pt-0 px-0 b-0 w-50"><img class="img-fluid img-40 rounded-circle w-40 h-40 bg-light p-1" src="../../../images/avatar/avatar-3.png" alt="user"></td>
		                                          <td class="pt-0 px-0 b-0"><a class="d-block fw-500 fs-14" href="#">Shuri</a><span class="text-fade">ID 23654</span></td>
		                                          <td class="text-end b-0 pt-0 px-0">
		                                            <button class="waves-effect waves-light btn btn-outline btn-rounded btn-primary mb-0 btn-sm">Deliverd</button>
		                                          </td>
		                                        </tr>
		                                        <tr>
		                                          <td class="pt-0 px-0 b-0 w-50"><img class="img-fluid img-40 rounded-circle w-40 h-40 bg-light p-1" src="../../../images/avatar/avatar-4.png" alt="user"></td>
		                                          <td class="pt-0 px-0 b-0"><a class="d-block fw-500 fs-14" href="#">Cahrli</a><span class="text-fade">ID 74125</span></td>
		                                          <td class="text-end b-0 pt-0 px-0">
		                                            <button class="waves-effect waves-light btn btn-outline btn-rounded btn-warning mb-0 btn-sm">Panding</button>
		                                          </td>
		                                        </tr>
		                                        <tr>
		                                          <td class="p-0 b-0 w-50"><img class="img-fluid img-40 rounded-circle w-40 h-40 bg-light p-1" src="../../../images/avatar/avatar-5.png" alt="user"></td>
		                                          <td class="p-0 b-0"><a class="d-block fw-500 fs-14" href="#">Leon</a><span class="text-fade">ID 21456</span></td>
		                                          <td class="text-end b-0 p-0">
		                                            <button class="waves-effect waves-light btn btn-outline btn-rounded btn-warning mb-0 btn-sm">Panding     </button>
		                                          </td>
		                                        </tr>
		                                    </tbody>
									...
									<div class="table-responsive">
										<table class="table mb-0">
											<tbody>
		                                        <tr>
		                                          <td class="pt-0 px-0 b-0 w-50">
		                                          	<img class="img-fluid img-40 rounded-circle w-40 h-40 bg-light p-1" src="../../../images/dashobard/mobile.jpg" alt="user">
		                                          </td>
		                                          <td class="pt-0 px-0 b-0"><a class="d-block fw-500 fs-14" href="#">Mobile</a><span class="text-fade">AT Studio</span></td>
		                                          <td class="text-end b-0 pt-0 px-0">
		                                            <p class="text-success m-0">$600</p>
		                                          </td>
		                                        </tr>
		                                        <tr>
		                                          <td class="pt-0 px-0 b-0 w-50"><img class="img-fluid img-40 rounded-circle w-40 h-40 bg-light p-1" src="../../../images/dashobard/chair.jpg" alt="user"></td>
		                                          <td class="pt-0 px-0 b-0"><a class="d-block fw-500 fs-14" href="#">Chair</a><span class="text-fade">AT Studio</span></td>
		                                          <td class="text-end b-0 pt-0 px-0">
		                                            <p class="text-success m-0">$150</p>
		                                          </td>
		                                        </tr>
		                                        <tr>
		                                          <td class="pt-0 px-0 b-0 w-50"><img class="img-fluid img-40 rounded-circle w-40 h-40 bg-light p-1" src="../../../images/dashobard/t-shirt.jpg" alt="user"></td>
		                                          <td class="pt-0 px-0 b-0"><a class="d-block fw-500 fs-14" href="#">T-shirt</a><span class="text-fade">AT Studio</span></td>
		                                          <td class="text-end b-0 pt-0 px-0">
		                                            <p class="text-success m-0">$60</p>
		                                          </td>
		                                        </tr>
		                                        <tr>
		                                          <td class="pt-0 px-0 b-0 w-50"><img class="img-fluid img-40 rounded-circle w-40 h-40 bg-light p-1" src="../../../images/dashobard/laptop.jpg" alt="user"></td>
		                                          <td class="pt-0 px-0 b-0"><a class="d-block fw-500 fs-14" href="#">Laptop</a><span class="text-fade">AT Studio</span></td>
		                                          <td class="text-end b-0 pt-0 px-0">
		                                            <p class="text-success m-0">$800</p>
		                                          </td>
		                                        </tr>
		                                        <tr>
		                                          <td class="p-0 b-0 w-50"><img class="img-fluid img-40 rounded-circle w-40 h-40 bg-light p-1" src="../../../images/dashobard/bag-2.jpg" alt="user"></td>
		                                          <td class="p-0 b-0"><a class="d-block fw-500 fs-14" href="#">Bag</a><span class="text-fade">AT Studio</span></td>
		                                          <td class="text-end b-0 p-0">
		                                            <p class="text-success m-0">$50</p>
		                                          </td>
		                                        </tr>
		                                    </tbody>
										</table>
						...
						<div class="col-xxl-3 col-xl-6 col-lg-6">
							<div class="card rounded-4">
								<div class="box-header d-flex b-0 justify-content-between align-items-center">
									<h4 class="box-title">Best Product</h4>
									<ul class="box-controls pull-right">
									  	<li class="dropdown">
											<a data-bs-toggle="dropdown" href="#" class="px-10 pt-1" aria-expanded="false"><i class="ti-more-alt"></i></a>
											<div class="dropdown-menu dropdown-menu-end" style="">
									...
									<div class="table-responsive">
										<table class="table mb-0">
											<tbody>
		                                        <tr>
		                                          <td class="pt-0 px-0 b-0 w-50">
		                                          	<img class="img-fluid img-40 rounded-circle w-40 h-40 bg-light p-1" src="../../../images/dashobard/headphone.jpg" alt="user">
		                                          </td>
		                                          <td class="pt-0 px-0 b-0"><a class="d-block fw-500 fs-14" href="#">Headphone</a><span class="text-fade">AT Studio</span></td>
		                                          <td class="text-end b-0 pt-0 px-0">
		                                            <div class="">
		                                        ...
		                                        <tr>
		                                          <td class="pt-0 px-0 b-0 w-50"><img class="img-fluid img-40 rounded-circle w-40 h-40 bg-light p-1" src="../../../images/dashobard/bag.jpg" alt="user"></td>
		                                          <td class="pt-0 px-0 b-0"><a class="d-block fw-500 fs-14" href="#">Bag</a><span class="text-fade">AT Studio</span></td>
		                                          <td class="text-end b-0 pt-0 px-0">
		                                            <div class="">
		                                              <i class="fa fa-star text-warning"></i>
		                                              <i class="fa fa-star text-warning"></i>
		                                        ...
		                                        <tr>
		                                          <td class="p-0 b-0 w-50"><img class="img-fluid img-40 rounded-circle w-40 h-40 bg-light p-1" src="../../../images/dashobard/mobile.jpg" alt="user"></td>
		                                          <td class="p-0 b-0"><a class="d-block fw-500 fs-14" href="#">Mobile</a><span class="text-fade">AT Studio</span></td>
		                                          <td class="text-end b-0 p-0">
		                                            <div class="">
		                                              <i class="fa fa-star text-warning"></i>
		                                              <i class="fa fa-star text-warning"></i>
						...
						<div class="col-xxl-3 col-lg-6">
                            <div class="box">
                                <div class="box-header d-flex justify-content-between align-items-center b-0">
                                    <h4 class="box-title">Earnings</h4>
                                    <div class="card-header-right-icon">
                                        <div>
                                            <i class="fa fa-exclamation-circle fs-20 text-fade mt-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Earnings alert"></i>
                                        </div>
                                    </div>
                                </div>
                                <div class="box-body pt-0 text-center">
                                    <div class="bg-light p-15 rounded-3">
                                        <i class="mdi mdi-wallet fs-50 text-primary l-h-60"></i>
                                        <h1 class="text-primary m-0 fw-600">$14,256</h1>
                                        <p class="text-primary m-0">Earnings This Month</p>
                                    </div>
                                    <div class="pb-15 p-20">
                                        <p class="mb-0">Update Your Payment</p>
                                        <p class="mb-1">Method In Setting</p>
                                    </div>
                                    <button class="btn btn-primary fs-18">Earnings Withdraw</button>
                                </div>
                            </div>
                        </div>
					</div>

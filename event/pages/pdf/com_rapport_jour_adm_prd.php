  ...
  //include('../phpqrcode/qrlib.php'); 
	...
	class myPDF extends FPDF{
      ...
      $datd = date('d');
			...
			$this->SetMargins(7,20,0,0,true);	
			$this->Cell(195,8,utf8_decode('Rapport de Commandes des abonées'),0,0,'C');
			$this->Ln(7);		
...
//--------------stock recu-----------------------
      ...
      $sqlt = "SELECT sum(qte) AS total_n from stock_transfere where cod_produit = '{$row_list_com['code_prodvente']}' AND id_depar =  '2'  AND date_enreg  between '$ha' and '$hb' AND recu = 'oui'";
      $reqt = $pdo->query($sqlt);  

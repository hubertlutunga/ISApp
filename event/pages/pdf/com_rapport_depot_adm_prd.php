  ...
  //include('../phpqrcode/qrlib.php'); 
	...
	class myPDF extends FPDF{
      ...
      $datd = date('d');
			...
			$this->Cell(195,8,utf8_decode('('.date('d M Y',strtotime($_GET['da'])).' au '.date('d M Y',strtotime($_GET['db'])).')'),0,0,'C');
			$this->Ln(5);	
			$this->SetTextColor(0, 0, 0);
			$this->SetFont('Arial','',11);		
			$this->Ln(10);			
      ...
      $sql = "SELECT distinct code_prodvente from commandes where typecli = '4' AND date_enreg between '$ha' and '$hb' order by code_com ASC";
      $req = $pdo->query($sql);  
...
//--------------nombre des commande produit-----------------------
      ...
      $sqlqtecom = "SELECT sum(qte) AS total_n from commandes where typecli = '4' AND code_prodvente = '{$row_list_com['code_prodvente']}' AND date_enreg between '$ha' and '$hb' AND code_cli != 'GROSS' AND code_cli != 'NULL'";
      ...
      $sqlmont_comt = "SELECT sum(pvt) AS total_n from commandes where  typecli = '4' AND code_prodvente = '{$row_list_com['code_prodvente']}' AND date_enreg between '$ha' and '$hb' AND code_cli != 'GROSS' AND code_cli != 'NULL'";
...
//--------------nombre des commande produit GROSS-----------------------
      ...
      $sqlqtecomgross = "SELECT sum(qte) AS total_n from commandes where typecli = '4' AND code_prodvente = '{$row_list_com['code_prodvente']}' AND date_enreg between '$ha' and '$hb' AND code_cli = 'GROSS'";
      ...
      $sqlmont_gross = "SELECT sum(pvt) AS total_n from commandes where typecli = '4' AND code_prodvente = '{$row_list_com['code_prodvente']}' AND date_enreg between '$ha' and '$hb' AND code_cli = 'GROSS'";
...
//--------------nombre des commande produit passant-----------------------
      ...
      $sqlqtecompassant = "SELECT sum(qte) AS total_n from commandes where typecli = '4' AND code_prodvente = '{$row_list_com['code_prodvente']}' AND date_enreg between '$ha' and '$hb' AND code_cli = 'NULL'";
      ...
      $sqlmont_pass = "SELECT sum(pvt) AS total_n from commandes where typecli = '4' AND code_prodvente = '{$row_list_com['code_prodvente']}' AND date_enreg between '$ha' and '$hb' AND code_cli = 'NULL'";
...
//--------------------------------calucule dette-----------------
      ...
      $sqlcomcred = "SELECT sum(pvt) AS total_ccr from commandes where typecli = '4' AND code_prodvente = '{$row_list_com['code_prodvente']}' AND date_enreg between '$ha' and '$hb' AND typ_paie = 'TR'";
      $comcred = $pdo->query($sqlcomcred);  
      $row_comcred = $comcred->fetch();

      $sqlcalcr = "SELECT sum(pvt) AS total_calcr from commandes where typecli = '4' AND code_prodvente = '{$row_list_com['code_prodvente']}' AND date_enreg between '$ha' and '$hb' AND typ_paie = 'CR'";  
      ...
      $row_calcr = $calcr->fetch();
          ...
          $sqlcred = "SELECT sum(montant) as total_cred from dette_paie where   date_ce between '$ha' and '$hb'";
...
//----------------------stock retour--------------------------------
      ...
      $sqlcom = "SELECT sum(qte) AS total_nc from commandes where typecli = '4' AND code_prodvente = '{$row_list_com['code_prodvente']}' AND date_enreg between '$ha' and '$hb' AND statut = 'liv'";
...
//--------------------------------calcule total nombre op-----------------
      ...
      $sqlcomttid = "SELECT count(code_com) AS total_id from commandes where typecli = '4' AND date_enreg between '$ha' and '$hb'";
      $comttid = $pdo->query($sqlcomttid);  
      $row_comttid = $comttid->fetch();

//--------------------------------calcule total qte com-----------------

      $sqlcomtt = "SELECT sum(qte) AS total_com from commandes where typecli = '4' AND date_enreg between '$ha' and '$hb'";
      $comtt = $pdo->query($sqlcomtt);  
      $row_comtt = $comtt->fetch();

//--------------------------------calcule total somme com-----------------

      $sqlcomsom = "SELECT sum(pvt) AS total_com from commandes where typecli = '4' AND date_enreg between '$ha' and '$hb'";
...
//--------------------------------calucule dette-----------------
      ...
      $sqlcomcredtt = "SELECT sum(pvt) AS total_ccr from commandes where typecli = '4' AND date_enreg between '$ha' and '$hb' AND typ_paie = 'TR'";
      $comcredtt = $pdo->query($sqlcomcredtt);  
      $row_comcredtt = $comcredtt->fetch();

      $sqlcalcrtt = "SELECT sum(pvt) AS total_calcr from commandes where typecli = '4' AND date_enreg between '$ha' and '$hb' AND typ_paie = 'CR'";  
      ...
      $row_calcrtt = $calcrtt->fetch();
          ...
          $sqlcredtt = "SELECT sum(montant) as total_cred from dette_paie where date_ce between '$ha' and '$hb'";

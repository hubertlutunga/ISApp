  ...
  //include('../phpqrcode/qrlib.php'); 
	...
	class myPDF extends FPDF{
		...
		function infodf($pdo){
			...
			$this->SetMargins(7,20,0,0,true);	
			$this->Cell(195,8,utf8_decode('Ingrédiens'),0,0,'C');
			$this->Ln(5);	
			$this->SetTextColor(0, 0, 0);
			$this->SetFont('Arial','',11);		
			$this->Ln(10);	
      ...
      $row_agent = $req->fetch();
			...
			$this->Cell(75,8,utf8_decode('Unités'),0,0,'L',true);
			$this->Ln(10);
			...
			$this->SetFont('Arial','',12);	
			$this->Cell(100,8,utf8_decode($row_ing['nom_ing']),'B',0,'L',true);
			$this->Cell(75,8,utf8_decode($row_ing['unite']),'B',0,'L',true);
			$this->Ln(9);

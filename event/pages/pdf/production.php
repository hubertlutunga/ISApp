  ...
  //include('../phpqrcode/qrlib.php'); 
	...
	class myPDF extends FPDF{
		...
		function infodf($pdo){
			...
			$this->SetMargins(7,20,0,0,true);		
			$this->Cell(195,8,utf8_decode('Production du '.date('d M Y',strtotime($_GET['da']))),0,0,'C');
			$this->Ln(5);	
			$this->SetTextColor(0, 0, 0);
			$this->SetFont('Arial','',11);		
			$this->Ln(10);	
...
*/
      ...
      $sqlistv = "SELECT * from production WHERE date_production between '$da' and '$db' AND statut = '$statut'  order by code_production DESC";

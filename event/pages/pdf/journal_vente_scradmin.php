  ...
  //include('../phpqrcode/qrlib.php'); 
	...
	class myPDF extends FPDF{
      ...
      $sqlistv = "SELECT * from vente_scr WHERE YEAR(date_vente) = '$daty' AND Month(date_vente) = '$datm' order by cod_vente DESC";
      ...
      $row_prod = $reqs->fetch();
			...
			$this->SetTextColor(0, 0, 0);
			$this->SetFont('Arial','B',12);
			$this->Cell(50,8,utf8_decode(number_format($row_listv['prix_t'], 2, '.', ' ').' CDF'),1,0,'R',true);
